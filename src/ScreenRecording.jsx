   ...
   <div>
      ...
      <Container className="pt-3">
       ...
       <div className="shadow">
        ...
        <  CardBody  >
        <center>
         <Link to="/screenRecording" outline onClick={() => this.startScreenRecord()} disabled={this.state.startDisable} > <img src={icon} alt="" /></Link>  </center>
         {/* <  Row  >
             < Col sm={12}  >
            <  h3 className='text-dark pb-2 textShadowHead text-center'>Screen Recording</  h3  >
            < h5 className="text-primary my-2">How it Works</  h5  >
    ...
    <  Button color='primary' outline onClick={() => this.startScreenRecord()} disabled={this.state.startDisable}  >
